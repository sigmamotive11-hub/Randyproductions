...
function Drum3D() {
  ...
  return (
    <group ref={groupRef} scale={1.5}>
      ...
      {/* Drum Tension Rods (Decorative lines connecting top and bottom) */}
...
export default function ThreeHero() {
  return (
    <div className="three-hero-container" style={{ position: 'absolute', top: 0, right: '-5%', width: '60%', height: '100%', zIndex: 0 }}>
